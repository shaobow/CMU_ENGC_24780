...
protected:
		...
		double area = 0;                    // area of shape
		double momX0 = 0, momY0 = 0;            // moments of inertia about centroid
		double centroidX = 0, centroidY = 0;    // location of centroid of shape
